...
RTOS_FILES +=   $(RTOS_SRC)/portable/GCC/mt2625/ARM_CM4F/port.c
RTOS_FILES +=   $(RTOS_SRC)/portable/GCC/mt2625/port_tick.c
else
...
ifeq ($(PRODUCT_VERSION),2625)
CFLAGS += -I$(SOURCE_DIR)/$(RTOS_SRC)/portable/GCC/mt2625/ARM_CM4F
else
