...
int main(void)
{
    ...
    status =  gsdk_ril_fotap_settv("YT_ME3616C1AV1.0B03","YT_ME3616C1AV1.0B03T01");  //set target version command(at+fotatv=ME3616C1AV1.0B03)

    status = gsdk_ril_fotap_ctr();  //start wefota (at+fotactr)
